...
@property (nonatomic, readonly, copy) void (^ _Nullable cellConfigurationClosure)(PESDKIconBorderedCollectionViewCell * _Nonnull, PESDKFrame * _Nullable);
...
/// This closure allows further customization of the cells of a frame.
@property (nonatomic, copy) void (^ _Nullable cellConfigurationClosure)(PESDKIconBorderedCollectionViewCell * _Nonnull, PESDKFrame * _Nullable);
...
SWIFT_CLASS_NAMED("LicenseModel")
@interface PESDKLicenseModel : NSObject
...
SWIFT_PROTOCOL_NAMED("PhotoEditPreviewControllerDelegate")
@protocol PESDKPhotoEditPreviewControllerDelegate
...
SWIFT_CLASS_NAMED("PhotoEffectMenuItem")
